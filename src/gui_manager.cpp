    ...
    mScene(scene)
{
    ...
    sendFloatMessage(mHdrExposure, GuiSettings::HDR_EXPLORATION);
...
void GuiManager::update()
{
    ...
    if (mHdrExposure.first != mHdrExposure.second)
        sendFloatMessage(mHdrExposure, GuiSettings::HDR_EXPLORATION);
...
void GuiManager::renderPropertyView() 
{
    ...
    if (ImGui::Begin("Object Property"))
    {
        ImGui::Text("Object:");
        {
            ...
            ImGui::SliderFloat("Itensity", &mBodyProperty.first.intensity, 1, 10);
