...
SphereNode::SphereNode(const glm::vec3& position, float radius, PhysicsManager* physics, short collisionGroup, short collisionMask, float mass, bool receiveMessages) :
    PhysicsNode(physics, receiveMessages),
    mRadius(radius)
{
